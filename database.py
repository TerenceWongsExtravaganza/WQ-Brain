...
"ebitda /fnd6_xints", # 利息保障倍数，衡量企业支付负债利息的能力
"sales /inventory", # 存货周转率，反映存货的周转速度
"fnd6_oiadps /revenue", # 营业利润率，体现企业经营活动的盈利能力
"income /assets", # 资产净利率，反映资产利用的综合效果
"receivable /sales", # 应收账款周转率，反映应收账款周转速度
"fnd6_newa2v1300_wcap /liabilities_curr", # 营运资本对流动负债的保障程度
...
"fnd6_xints /debt", # 债务的利息率，反映企业债务融资的成本
...
"inventory /assets_curr", # 存货占流动资产的比例，反映企业流动资产的结构
"income /invested_capital", # 投资净利率，衡量投入资本获取净收益的能力
"return_assets /return_equity", # 资产回报率与权益回报率的比值，反映权益乘数对回报率的影响
"fnd6_oiadps /operating_expense", # 营业利润与营业成本的比值，衡量企业经营效益
"liabilities /assets", # 资产负债率的另一种表达，衡量企业的负债水平
"ebit /fnd6_xints", # 息税前利润对利息的保障倍数，衡量企业支付利息的能力
"income /revenue", # 销售净利率，反映企业销售收入的收益水平
"receivable /assets_curr", # 应收账款占流动资产的比例，反映流动资产的质量
"fnd6_newa2v1300_wcap /assets", # 营运资本占资产的比例，反映企业资产的流动性和偿债能力
...
"rd_expense /fnd6_oiadps", # 研发投入对营业利润的占比，反映企业在盈利基础上的研发投入情况
"sga_expense /fnd6_oiadps", # 销售及管理费用对营业利润的占比，反映运营成本对利润的影响
"inventory_turnover /liabilities_curr", # 存货周转率与流动负债的关系，从存货周转角度看对流动负债的影响
"return_equity /return_assets", # 权益回报率与资产回报率的比值，反映权益杠杆的作用
"operating_expense /fnd6_oiadps", # 营业成本对营业利润的覆盖倍数，衡量企业盈利空间
...
"fnd6_xints /fnd6_oiadps", # 利息费用对营业利润的占比，反映利息负担对企业盈利的影响
"retained_earnings /assets", # 留存收益占资产的比例，反映企业资产中留存收益的构成
"income_beforeextra /equity", # 剔除特殊项目前的净资产收益率，衡量企业正常经营的股东权益收益水平
"cash /liabilities_curr", # 现金对流动负债的保障程度，反映企业短期偿债的即时能力
"capex /income", # 资本支出与净利润的比例，反映企业用净利润进行投资的能力
"inventory /liabilities", # 存货对负债的比例，反映存货作为偿债   资源的能力
"income /fnd6_oiadps", # 净利润与营业利润的比值，反映企业的盈利质量
"return_assets * equity /assets", # 从资产回报率推导权益相关指标的一种变形
"fnd6_oiadps /liabilities", # 营业利润对负债的比例，反映企业营业利润对负债的覆盖能力
...
"fnd6_newa2v1300_wcap /revenue", # 营运资本对营收的比例，反映营运资本对业务的支持程度
"capex /liabilities_curr", # 资本支出对流动负债的比例，反映流动负债对资本支出的支持能力
"debt /assets_curr", # 流动资产的资产负债率，衡量流动资产的负债水平
"income_tax /fnd6_oiadps", # 营业利润的税负率，反映营业利润所承担的税收负担
...
"fnd6_xints /pretax_income", # 利息费用对税前利润的占比，反映利息负担对税前利润的影响
...
"inventory /fnd6_newa2v1300_wcap", # 存货对营运资本的比例，反映存货在营运资本中的占比
"income /liabilities", # 净利润对负债的比例，反映企业净利润对负债的偿还能力
"return_assets * liabilities /assets", # 从资产回报率推导负债相关指标的一种变形
"fnd6_oiadps /assets_curr", # 流动资产的营业利润率，衡量流动资产的经营效益
...
"sales /fnd6_newa2v1300_wcap", # 营运资本周转率，反映营运资本的利用效率
"capex /fnd6_oiadps", # 资本支出对营业利润的比例，反映营业利润对资本支出的支持能力
"debt /liabilities_curr", # 流动负债中债务的比例，反映流动负债的构成
"income_tax /income", # 净利润的实际税负率，反映企业净利润的税收负担
...
"liabilities_curr /fnd6_newa2v1300_wcap", # 流动负债对营运资本的比例，反映流动负债与营运资本的关系
...
"fnd6_xints /income", # 利息费用对净利润的占比，反映利息负担对净利润的影响
...
"cash /fnd6_newa2v1300_wcap", # 现金对营运资本的比例，反映现金在营运资本中的占比
"capex /cashflow_op", # 资本支出对经营活动现金流量的比例，反映经营活动现金流量对资本支出的支持能力
"inventory /current_ratio", # 存货与流动比率的关系，从存货角度看流动比率情况
"income /assets_curr", # 流动资产净利率，反映流动资产的综合收益能力
"return_assets * fnd6_newa2v1300_wcap /assets", # 从资产回报率推导营运资本相关指标的一种变形
"fnd6_oiadps /fnd6_newa2v1300_wcap", # 营运资本的营业利润率，衡量营运资本的经营效益
"liabilities /fnd6_newa2v1300_wcap", # 营运资本的负债比率，衡量营运资本的负债程度
"ebit /fnd6_newa2v1300_wcap", # 营运资本的息税前利润率，衡量营运资本的获利能力
"income /fnd6_newa2v1300_wcap", # 营运资本的收益率，反映营运资本的收益水平
"cashflow_op /fnd6_newa2v1300_wcap", # 经营活动现金流量对营运资本的比例，反映营运资本产生现金流量的能力
"ebitda /fnd6_newa2v1300_wcap", # 营运资本的息税折旧摊销前利润率，衡量营运资本在未扣除折旧摊销前的盈利能力
"sales /current_ratio", # 销售额与流动比率的关系，从销售角度看流动比率情况
"capex /income_tax", # 资本支出对所得税的比例，反映所得税对资本支出的影响
"debt /fnd6_newa2v1300_wcap", # 营运资本中债务的比例，反映营运资本的构成
...
"inventory_turnover * 365 /fnd6_newa2v1300_wcap", # 存货周转天数与营运资本的关系，从存货周转角度看对营运资本的影响
"return_equity * fnd6_newa2v1300_wcap /equity", # 从权益回报率推导营运资本相关指标的一种变形
"operating_expense /fnd6_newa2v1300_wcap", # 营运资本的营业成本率，衡量营运资本的成本水平
"liabilities_curr /current_ratio * assets_curr", # 从流动比率和流动资产推导流动负债的一种变形
"pretax_income /fnd6_newa2v1300_wcap", # 税前营运资本收益率，衡量企业在税前的营运资本获利能力
"goodwill /fnd6_newa2v1300_wcap", # 商誉对营运资本的比例，反映商誉在营运资本中的占比
"sales_growth /fnd6_newa2v1300_wcap", # 销售增长率对营运资本的比例，反映营运资本对销售增长的支持能力
"ppent /fnd6_newa2v1300_wcap", # 固定资产净值对营运资本的比例，反映固定资产对营运资本的贡献
"fnd6_xints /cashflow_op", # 利息费用对经营活动现金流量的占比，反映利息负担对经营活动现金流量的影响
"retained_earnings /fnd6_newa2v1300_wcap", # 留存收益对营运资本的比例，反映留存收益在营运资本中的构成
"income_beforeextra /fnd6_newa2v1300_wcap", # 剔除特殊项目前的营运资本收益率，衡量企业正常经营的营运资本获利能力
"cash /current_ratio * assets_curr", # 从流动比率和流动资产推导现金的一种变形
"capex /net_cashflow", # 资本支出对净现金流量（假设存在相关计算或数据）的比例，反映净现金流量对资本支出的支持能力
"inventory /fnd6_oiadps", # 存货对营业利润的比例，反映存货对营业利润的影响
"income /fnd6_newa2v1300_wcap", # 营运资本的净利润率，反映营运资本的盈利水平
"return_assets * assets_curr /assets", # 从资产回报率推导流动资产相关指标的一种变形
"fnd6_oiadps /assets_curr", # 流动资产的营业利润率，衡量流动资产的经营效益
"liabilities /assets_curr", # 流动资产的负债比率，衡量流动资产的负债程度
]
